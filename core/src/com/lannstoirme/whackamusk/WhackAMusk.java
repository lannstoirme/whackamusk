package com.lannstoirme.whackamusk;
...
import com.lannstoirme.whackamusk.managers.GameManager;

public class WhackAMusk extends ApplicationAdapter {
	...
	public void create() {
		...
		camera = new OthographicCamera(width,height);
